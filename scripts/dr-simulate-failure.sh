...
# Ride out transient network/DNS blips instead of aborting the whole run — the
# AWS CLI retries transient failures automatically. Override by exporting either var.
